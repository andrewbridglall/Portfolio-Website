...
function App() {
  return (
    <div className="App">
      ...
      <p>
      <a className="App-link" href="https://drive.google.com/file/d/1DZUEaPmTHrvHnKF54-JNBcYzyO8tXwa6/view?usp=sharing" target="_blank" rel="noopener noreferrer">Resume</a>&nbsp;|&nbsp;
