...
function App() {
  return (
    <div className="App">
      ...
      <p>
      <a className="App-link" href="https://drive.google.com/file/d/1Hq0JqeuBm4yMEeoggcym3SFiXncpOJlV/view?usp=sharing" target="_blank" rel="noopener noreferrer">Resume</a>&nbsp;|&nbsp;
