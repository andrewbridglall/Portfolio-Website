...
function App() {
  return (
    <div className="App">
      ...
      <p>
      <a className="App-link" href="https://drive.google.com/file/d/1ORIsB_SjvL4MP640ru5FhrI4BxWTTYUX/view?usp=sharing" target="_blank" rel="noopener noreferrer">Resume</a>&nbsp;|&nbsp;
