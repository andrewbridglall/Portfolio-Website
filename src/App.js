...
function App() {
  return (
    <div className="App">
      ...
      <p>
      <a className="App-link" href="https://drive.google.com/file/d/1IefhYWz2ArlSLNSPB2boZVLlR-R9seT2/view?usp=sharing" target="_blank" rel="noopener noreferrer">Resume</a>&nbsp;|&nbsp;
